# Soumik Ghosh | Frontend Developer Portfolio
...
- **Visuals**: Dark mode aesthetic with subtle glassmorphism (`backdrop-filter`) and calculated gradients.
...
1.  **Clone the repository**
    ```bash
    git clone https://github.com/soumik-27/portfolio.git
    ```
...
© 2025 Soumik Ghosh. All rights reserved.
